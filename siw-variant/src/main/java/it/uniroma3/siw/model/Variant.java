...
public class Variant {
	...
	public String toString() {
		return "Variant [id=" + id + ", nomeVariant=" + nomeVariant + ", dataUscita=" + dataUscita + ", pathImmagine="
				+ pathImmagine + ", descrizione=" + descrizione + ", rarità=" + rarità + ", effettoCopertina="
				+ effettoCopertina + ", editore=" + editore + ", manga=" + manga + ", volume=" + volume + "]";
	}
