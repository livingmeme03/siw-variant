...
INSERT INTO variant (id, data_uscita, manga_id, rarità, effetto_copertina, editore_id, volume) VALUES(nextval('variant_seq'), '2023-01-01', (SELECT id FROM manga WHERE titolo='ZZZZ'), 0, 'effetto fantastico', (SELECT id FROM editore WHERE nome='J-POP'), 1)
INSERT INTO variant (id, data_uscita, manga_id, rarità, effetto_copertina, editore_id, volume) VALUES(nextval('variant_seq'), '2023-01-01', (SELECT id FROM manga WHERE titolo='AAAA'), 0, 'effetto fantastico', (SELECT id FROM editore WHERE nome='J-POP'), 1)
INSERT INTO variant (id, data_uscita, manga_id, rarità, effetto_copertina, editore_id, volume) VALUES(nextval('variant_seq'), '2023-01-01', (SELECT id FROM manga WHERE titolo='BBB'), 0, 'effetto fantastico', (SELECT id FROM editore WHERE nome='J-POP'), 1)
